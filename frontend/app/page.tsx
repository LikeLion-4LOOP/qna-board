...
const exampleQuestions: Question[] = [
  {
    ...
    content:
      "React에서 상태 관리를 하는 방법에 대해 궁금합니다. useState와 useReducer의 차이점도 알고 싶어요.",
    username: "개발자1",
  ...
  },
  {
    ...
    content:
      "Next.js와 React의 주요 차이점과 각각의 장단점에 대해 알고 싶습니다.",
    username: "학습자",
  ...
  },
  {
    ...
    content:
      "JavaScript 대신 TypeScript를 사용하는 이유와 장점에 대해 궁금합니다.",
    username: "프론트엔드",
  ...
  },
  {
    ...
    content:
      "집에서 만들 수 있는 간단하고 맛있는 파스타 레시피를 찾고 있습니다.",
    username: "요리사",
...
export default function Home() {
  ...
  const loadQuestions = async () => {
    try {
      ...
      setError(
        "실제 데이터를 불러오는데 실패했습니다. 예시 데이터를 표시합니다."
      );
    } finally {
      setLoading(false);
    }
                  ...
                  {popularQuestions.map((question, index) => {
                    ...
                    if (question.category) {
                      ...
                      categoryMatch = CATEGORIES.find((cat) =>
                        question.tag?.includes(cat.name)
                      );
                    }
                    return (
                      <Link
